...
public class NlpController {
	...
	public String wordAnalysis(HttpServletRequest request, HttpServletResponse reponse, Model model) throws Exception {
		...
		if(point < 0 ) {
			...
			res = "\"" + text_message + "\"문장의 분석결과는 데이터 사전에 존재하지 않습니다 .";
		}else {
